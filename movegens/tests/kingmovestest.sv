...
generate a bunch of moves for king.
find out if they are legal. 
we get the position in. 
then, we will later have to figure out if the move
for any of the positions, the state will have to be modified. 
