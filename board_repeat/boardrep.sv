...
import movevector::*;
/*
What this one needs: two rows, one for white and one for black. Each are fairly long and linked. 
...
module boardrep(
    input logic [11:0] moves [49:0];

    output logic draw;
);

    logic [11:0] leftmoves [24:0];
    logic [11:0] rightmoves[24:0];
    logic repeatedstate [49:0];

    movevector leftvectors[24:0];
    movevector rightvectors[24:0];

    logic [7:0] counter[49:0];
