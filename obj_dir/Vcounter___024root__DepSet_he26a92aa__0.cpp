...
VL_INLINE_OPT void Vcounter___024root___nba_sequent__TOP__0(Vcounter___024root* vlSelf) {
    ...
    if (vlSelf->rst) {
        ...
        __Vdly__count = (0xfU & ((IData)(1U) + (IData)(vlSelf->count)));
    }
...
#endif
            VL_FATAL_MT("hw/counter.sv", 1, "", "NBA region did not converge.");
        }
...
#endif
                VL_FATAL_MT("hw/counter.sv", 1, "", "Active region did not converge.");
            }
