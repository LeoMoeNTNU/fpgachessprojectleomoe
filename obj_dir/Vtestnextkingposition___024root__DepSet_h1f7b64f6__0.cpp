...
void Vtestnextkingposition___024root___eval_triggers__act(Vtestnextkingposition___024root* vlSelf) {
    ...
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtestnextkingposition___024root___eval_triggers__act\n"); );
    // Body
    vlSelf->__VactTriggered.set(0U, ((IData)(vlSelf->testnextkingposition__DOT__clk) 
                                     & (~ (IData)(vlSelf->__Vtrigprevexpr___TOP__testnextkingposition__DOT__clk__0))));
