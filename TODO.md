# There is probably a bug in threatened that lets you see through pieces. 
...
I need the threatened-component both for the king and for the castling. 
Now I need to make some good tests for this component really soon. 
There seems to be an error for some reason because it doesn't answer correctly. 
I should implement a debug-component for castling and try to figure this out. 
...
This I almost have, so I just have to implement it. I have written the code (very little code), so now the goal of this one is to just 
